...
# Create title label
title_label = tk.Label(root, text="To-Do List", font=("dallas", 16, "bold"),bg='lightblue')
title_label.pack(pady=10)

# Create task entry
task_entry = tk.Entry(root, width=40,bg='pink')
...
# Create task listbox
task_listbox = tk.Listbox(root, width=50,bg='pink')
